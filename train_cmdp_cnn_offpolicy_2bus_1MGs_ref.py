...
from rl_torch.nn import Actor_sequence, Actor_sequence_sig, Critic_sequence,\
    Actor_sequence_small, Actor_sequence_small_sig, Critic_sequence_small, Critic_sequence_linear,\
...
agents = multi_agent_system(agent_num=env.MG_num, device=device, communication_matrix=w,
                            actor_fn=Actor_sequence_small, sample_fn=normal_sample,
                            critic_fn=Critic_sequence_small, state_dim=state_dim,
