...
agents = multi_agent_system(agent_num=env.MG_num, device=device, communication_matrix=w,
                            ...
                            constraint_num=1, gamma=.99, tau=.95,
                            memory_volume=buffer_size,
...
for epsiode in range(max_episode):
    ...
    for _ in range(iterations):
        ...
        agents.train_batch(batch_size=batch_size, critic_iter=2, actor_iter=1)
