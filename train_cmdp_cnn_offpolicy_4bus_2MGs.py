...
import torch
from rl_torch.nn import Actor_sequence, Critic_sequence, Actor_sequence_small, Critic_sequence_small
import numpy as np
...
if __name__ == '__main__':
    ...
    # record_min = 1e4
    record_interval = 1
    logfile = open('results/4bus_2MGs/4bus_2MGs_gub%2.2f_' % g_ub
    ...
    agents = multi_agent_system(agent_num=env.MG_num, device=device, communication_matrix=w1,
                                actor_fn=Actor_sequence_small, critic_fn=Critic_sequence_small, state_dim=state_dim,
