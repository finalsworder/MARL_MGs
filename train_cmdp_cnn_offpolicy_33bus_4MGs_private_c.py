...
logfile_name = 'results/33bus_4MGs/33bus_4MGs_gub%.3f_' % g_ub + time_str + '.csv'
logfile = open(logfile_name, 'w+', newline='')
cg_file_name = 'results/33bus_4MGs/33bus_4MGs_gub%.3f_' % g_ub + time_str + '_cg.csv'
